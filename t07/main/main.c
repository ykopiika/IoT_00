...
///-----------------------------------------------------------------------------------
	...
	str_to_buf(buffer, "All the greatest technological inventions created by man - the plane, the car, the computer - are more indicative of his laziness than of high intelligence.");
	write_lcd(buffer);
